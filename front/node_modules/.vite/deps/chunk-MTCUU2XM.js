...
function deepClone2(source) {
  if (React26.isValidElement(source) || (0, import_react_is3.isValidElementType)(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
  Object.keys(source).forEach((key) => {
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React26.isValidElement(source[key]) || (0, import_react_is3.isValidElementType)(source[key])) {
        output[key] = source[key];
...
function createThemeWithVars(options = {}, ...args) {
  ...
  theme = args.reduce((acc, argument) => deepmerge2(acc, argument), theme);
  const parserConfig = {
    prefix: cssVarPrefix,
    disableCssColorScheme,
    shouldSkipGeneratingVar: shouldSkipGeneratingVar2,
...
export {
  ClassNameGenerator_default2 as ClassNameGenerator_default,
  capitalize_default,
  require_prop_types,
  clsx_default,
  composeClasses,
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MTCUU2XM.js.map
