...
function useBarSeries() {
  const series = useSeries();
  return React15.useMemo(() => series.bar, [series.bar]);
}
function useScatterSeries() {
  const series = useSeries();
  return React15.useMemo(() => series.scatter, [series.scatter]);
}
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React21.useMemo(() => {
  ...
  const providerValue = React21.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React22.useContext(HighlightedContext);
  if (!isInitialized) {
...
var useStringInterpolator = (path2) => {
  ...
  const interpolator = React28.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(React32.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style) => (0, import_jsx_runtime8.jsx)(animated.rect, {
        // @ts-expect-error
        x: 0,
        y: 0,
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-area-clip`,
    children: transitionChange((style, interpolator) => (
      // @ts-expect-error
      (0, import_jsx_runtime9.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(Area, _extends({}, other, areaProps));
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime11.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime11.jsxs)(React35.Fragment, {
        children: [(0, import_jsx_runtime11.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime11.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime12.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime12.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function useChartGradient() {
  const {
    chartId
  } = React37.useContext(DrawingContext);
  return React37.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime13.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime13.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime13.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var AnimationContext = React38.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React39.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime14.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React40.useContext(AnimationContext);
  if (!isInitialized) {
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime15.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime15.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-line-clip`,
    children: transitionChange((style, interpolator) => (
      // @ts-expect-error
      (0, import_jsx_runtime16.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: style.value.to(interpolator)
      }))
    ))
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime18.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      d,
      seriesId,
      color: color2,
      ...
      return (0, import_jsx_runtime18.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var ChartsSurface = React46.forwardRef(function ChartsSurface2(inProps, ref) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React47.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React47.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React48.useRef(null);
...
var ChartContainer = React49.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime20.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime20.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime20.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime20.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime20.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime20.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime20.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime20.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime20.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
true ? ChartContainer.propTypes = {
   ...
   */
  plugins: import_prop_types10.default.arrayOf(import_prop_types10.default.object),
  /**
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
    colorMap: import_prop_types10.default.oneOfType([import_prop_types10.default.shape({
      colors: import_prop_types10.default.arrayOf(import_prop_types10.default.string).isRequired,
      type: import_prop_types10.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types10.default.string,
...
var ResponsiveChartContainer = React51.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime21.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types11.default.arrayOf(import_prop_types11.default.object),
  /**
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types11.default.bool,
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
  ...
  xAxis: import_prop_types11.default.arrayOf(import_prop_types11.default.shape({
    ...
    domainLimit: import_prop_types11.default.oneOfType([import_prop_types11.default.oneOf(["nice", "strict"]), import_prop_types11.default.func]),
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types11.default.arrayOf(import_prop_types11.default.shape({
    colorMap: import_prop_types11.default.oneOfType([import_prop_types11.default.shape({
      colors: import_prop_types11.default.arrayOf(import_prop_types11.default.string).isRequired,
      type: import_prop_types11.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types11.default.string,
...
function CircleMarkElement(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(animated.circle, _extends({}, other, {
    // @ts-expect-error
    cx: position.x,
    cy: position.y,
    r: 5,
...
true ? CircleMarkElement.propTypes = {
   ...
   */
  shape: import_prop_types12.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
function MarkElement(props) {
  ...
  const classes = useUtilityClasses3(ownerState);
  return (0, import_jsx_runtime23.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
true ? MarkElement.propTypes = {
   ...
   * The index to the element in the series' data array.
   */
  dataIndex: import_prop_types13.default.number.isRequired,
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime24.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime24.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
true ? MarkPlot.propTypes = {
   ...
   * @default false
   */
  experimentalRendering: import_prop_types14.default.bool,
  /**
...
function ChartsText(props) {
  ...
  const wordsByLines = React55.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime25.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime25.jsx)("tspan", {
      x: x2,
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime26.jsxs)(XAxisRoot, {
    transform: `translate(0, ${position === "bottom" ? top + height : top})`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime26.jsx)(Line, _extends({
      x1: left,
      x2: left + width,
      ...
      return (0, import_jsx_runtime26.jsxs)("g", {
        transform: `translate(${offset}, 0)`,
        className: classes.tickContainer,
        children: [!disableTicks && showTick && (0, import_jsx_runtime26.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime26.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime26.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime26.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime27.jsxs)(YAxisRoot, {
    transform: `translate(${position === "right" ? left + width : left}, 0)`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime27.jsx)(Line, _extends({
      y1: top,
      y2: top + height,
      className: classes.line
      ...
      return (0, import_jsx_runtime27.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime27.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime27.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime27.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime27.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React59.Fragment, {
    children: [topId && (0, import_jsx_runtime28.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime28.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime28.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime28.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React60.useState(null);
  React60.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime29.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime29.jsx)("tbody", {
        children: (0, import_jsx_runtime29.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime29.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime29.jsx)(ChartsTooltipMark, {
              color: color2,
              className: classes.mark
            })
          }), (0, import_jsx_runtime29.jsx)(ChartsTooltipCell, {
...
function ChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime31.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime31.jsx)("thead", {
        children: (0, import_jsx_runtime31.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime31.jsx)(ChartsTooltipCell, {
            colSpan: 3,
            children: (0, import_jsx_runtime31.jsx)(Typography_default, {
      ...
      }), (0, import_jsx_runtime31.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime31.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime31.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color2 && (0, import_jsx_runtime31.jsx)(ChartsTooltipMark, {
                color: color2,
                className: classes.mark
              })
            }), (0, import_jsx_runtime31.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime31.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types20.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types20.default.shape({
    x: import_prop_types20.default.shape({
      index: import_prop_types20.default.number,
      value: import_prop_types20.default.oneOfType([import_prop_types20.default.instanceOf(Date), import_prop_types20.default.number, import_prop_types20.default.string]).isRequired
    }),
    y: import_prop_types20.default.shape({
      index: import_prop_types20.default.number,
      value: import_prop_types20.default.oneOfType([import_prop_types20.default.instanceOf(Date), import_prop_types20.default.number, import_prop_types20.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types20.default.oneOfType([import_prop_types20.default.instanceOf(Date), import_prop_types20.default.number, import_prop_types20.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime33.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime33.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime33.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime33.jsx)(ChartsAxisTooltipContent, {
...
function useItemTooltip() {
  ...
  const {
    zAxis,
    zAxisIds
  } = React66.useContext(ZAxisContext);
  const colorProcessors = useColorProcessor();
  const xAxisId = series.xAxisId ?? series.xAxisKey ?? xAxisIds[0];
  const yAxisId = series.yAxisId ?? series.yAxisKey ?? yAxisIds[0];
  const zAxisId = series.zAxisId ?? series.zAxisKey ?? zAxisIds[0];
...
function useAxisTooltip() {
  const {
    axis
  } = React67.useContext(InteractionContext);
  const series = useSeries();
  const {
    xAxis,
    yAxis,
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)("g", {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React69.useMemo(
  ...
  const padding = React69.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React69.useCallback((label, inStyle = {}) => {
    const style = _objectWithoutPropertiesLoose(inStyle, _excluded18);
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React69.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React69.useMemo(() => {
  ...
  return (0, import_jsx_runtime35.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime35.jsx)(ChartsLegendRoot, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types22.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types22.default.shape({
    bottom: import_prop_types22.default.number.isRequired,
    height: import_prop_types22.default.number.isRequired,
    left: import_prop_types22.default.number.isRequired,
    right: import_prop_types22.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types22.default.arrayOf(import_prop_types22.default.shape({
    ...
    itemId: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string]),
    label: import_prop_types22.default.string.isRequired,
    maxValue: import_prop_types22.default.oneOfType([import_prop_types22.default.instanceOf(Date), import_prop_types22.default.number]),
    minValue: import_prop_types22.default.oneOfType([import_prop_types22.default.instanceOf(Date), import_prop_types22.default.number]),
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime37.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime38.jsxs)(React73.Fragment, {
    children: [(0, import_jsx_runtime38.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime38.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types24.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.string]),
  /**
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types24.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types24.default.number,
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types25.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types25.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types25.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime40.jsxs)(React75.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime40.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime40.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime40.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime40.jsx)(ChartsAxisHighlightPath, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime41.jsx)("clipPath", {
    id,
    children: (0, import_jsx_runtime41.jsx)("rect", {
      x: left - offset.left,
      y: top - offset.top,
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime43.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime43.jsx)(Element, _extends({
          id: seriesId,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(React79.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime44.jsx)(GridLine, {
      y1: drawingArea.top,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(React80.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime45.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: drawingArea.left,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime46.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime46.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime46.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React82.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime47.jsx)(React82.Fragment, {});
}
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime50.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime50.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var LineChart = React86.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
...
true ? LineChart.propTypes = {
   ...
   */
  experimentalMarkRendering: import_prop_types32.default.bool,
  /**
  ...
  legend: import_prop_types32.default.shape({
    ...
    itemGap: import_prop_types32.default.number,
    itemMarkHeight: import_prop_types32.default.number,
    itemMarkWidth: import_prop_types32.default.number,
    labelStyle: import_prop_types32.default.object,
    markGap: import_prop_types32.default.number,
    onItemClick: import_prop_types32.default.func,
    padding: import_prop_types32.default.oneOfType([import_prop_types32.default.number, import_prop_types32.default.shape({
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types32.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
...
//# sourceMappingURL=chunk-XISZ7VHV.js.map
