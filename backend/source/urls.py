...
urlpatterns = [
    ...
    path("sources/<uuid:id_source>/registry/keys/",csrf_exempt(views.SourceRegistryKeys.as_view()),name="get_source_registry_parent"),
    path("sources/<uuid:id_source>/registry/values/",csrf_exempt(views.SourceRegistryValues.as_view()),name="get_source_registry_parent"),
