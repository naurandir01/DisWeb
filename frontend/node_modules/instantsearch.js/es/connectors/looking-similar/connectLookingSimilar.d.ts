...
import type { Connector, TransformItems, BaseHit, Renderer, Unmounter, UnknownWidgetParams, RecommendResponse, Hit, AlgoliaHit } from 'instantsearch.js/es/types';
...
declare const _default: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<LookingSimilarRenderState, TWidgetParams & LookingSimilarConnectorParams>, unmountFn?: Unmounter) => <THit extends NonNullable<object> = BaseHit>(widgetParams: TWidgetParams & LookingSimilarConnectorParams<THit>) => {
    ...
    getWidgetRenderState({ results, helper, instantSearchInstance }: import("instantsearch.js/es/types").InitOptions | import("instantsearch.js/es/types").RenderOptions | ({
        ...
        parent: import("instantsearch.js/es/types").IndexWidget;
        ...
        renderState: import("instantsearch.js/es/types").IndexRenderState;
