import type { IndexWidget } from 'instantsearch.js/es/widgets';
import type { RecommendResponse } from 'instantsearch.js/es/types/algoliasearch';
import type { InstantSearch } from 'instantsearch.js/es/types/instantsearch';
import type { IndexRenderState, WidgetRenderState } from 'instantsearch.js/es/types/render-state';
import type { IndexUiState, UiState } from 'instantsearch.js/es/types/ui-state';
import type { Expand, RequiredKeys } from 'instantsearch.js/es/types/utils';
...
export type { IndexWidget } from 'instantsearch.js/es/widgets';
