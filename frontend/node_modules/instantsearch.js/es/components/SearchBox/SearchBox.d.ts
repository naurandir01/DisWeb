...
import type { ComponentCSSClasses } from 'instantsearch.js/es/types';
import type { SearchBoxCSSClasses, SearchBoxTemplates } from 'instantsearch.js/es/widgets/search-box/search-box';
