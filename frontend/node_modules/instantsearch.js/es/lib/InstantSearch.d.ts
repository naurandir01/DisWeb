...
import type { InsightsEvent, InsightsProps } from 'instantsearch.js/es/middlewares/createInsightsMiddleware';
import type { RouterProps } from 'instantsearch.js/es/middlewares/createRouterMiddleware';
import type { InsightsClient as AlgoliaInsightsClient, SearchClient, Widget, IndexWidget, UiState, CreateURL, Middleware, MiddlewareDefinition, RenderState, InitialResults, CompositionClient } from 'instantsearch.js/es/types';
