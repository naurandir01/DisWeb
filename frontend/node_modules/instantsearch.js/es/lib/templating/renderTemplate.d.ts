import type { Templates, HoganHelpers } from 'instantsearch.js/es/types';
import type { BindEventForHits, SendEventForHits } from 'instantsearch.js/es/lib/utils/createSendEventForHits';
