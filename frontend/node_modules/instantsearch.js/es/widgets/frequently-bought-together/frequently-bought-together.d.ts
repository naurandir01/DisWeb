...
import type { FrequentlyBoughtTogetherWidgetDescription, FrequentlyBoughtTogetherConnectorParams } from 'instantsearch.js/es/connectors/frequently-bought-together/connectFrequentlyBoughtTogether';
import type { Template, WidgetFactory, BaseHit, RecommendResponse, Hit, TemplateWithBindEvent } from 'instantsearch.js/es/types';
...
declare const _default: <THit extends NonNullable<object> = BaseHit>(widgetParams: FrequentlyBoughtTogetherWidgetParams<THit> & FrequentlyBoughtTogetherConnectorParams<THit>) => {
    ...
    init(initOptions: import("instantsearch.js/es/types").InitOptions): void;
    render(renderOptions: import("instantsearch.js/es/types").RenderOptions): void;
    getRenderState(renderState: {
        ...
        hits?: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/hits/connectHits").HitsRenderState<BaseHit>, import("instantsearch.js/es/connectors/hits/connectHits").HitsConnectorParams<BaseHit>> | undefined;
        ...
        infiniteHits?: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/infinite-hits/connectInfiniteHits").InfiniteHitsRenderState<BaseHit>, import("instantsearch.js/es/connectors/infinite-hits/connectInfiniteHits").InfiniteHitsConnectorParams<BaseHit>> | undefined;
        menu?: {
        ...
        range?: {
            [attribute: string]: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/range/connectRange").RangeRenderState, import("instantsearch.js/es/connectors/range/connectRange").RangeConnectorParams>;
        } | undefined;
        ratingMenu?: {
        ...
        places?: import("instantsearch.js/es/types").WidgetRenderState<Record<string, unknown>, import("instantsearch.js/es/widgets/places/places").PlacesWidgetParams> | undefined;
    }): {
        answers?: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/answers/connectAnswers").AnswersRenderState, import("instantsearch.js/es/connectors/answers/connectAnswers").AnswersConnectorParams> | undefined;
        autocomplete?: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/autocomplete/connectAutocomplete").AutocompleteRenderState, import("instantsearch.js/es/connectors/autocomplete/connectAutocomplete").AutocompleteConnectorParams> | undefined;
        breadcrumb?: {
    ...
    getWidgetRenderState({ results, helper, instantSearchInstance }: import("instantsearch.js/es/types").InitOptions | import("instantsearch.js/es/types").RenderOptions | ({
        ...
        renderState: Partial<{
            ...
            hits: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/hits/connectHits").HitsRenderState<BaseHit>, import("instantsearch.js/es/connectors/hits/connectHits").HitsConnectorParams<BaseHit>>;
        } & {
            ...
            infiniteHits: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/infinite-hits/connectInfiniteHits").InfiniteHitsRenderState<BaseHit>, import("instantsearch.js/es/connectors/infinite-hits/connectInfiniteHits").InfiniteHitsConnectorParams<BaseHit>>;
        } & {
            menu: {
                [attribute: string]: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/menu/connectMenu").MenuRenderState, import("instantsearch.js/es/connectors/menu/connectMenu").MenuConnectorParams>;
            };
        ...
        createURL: (nextState: import("algoliasearch-helper").SearchParameters | ((state: import("instantsearch.js/es/types").IndexUiState) => import("instantsearch.js/es/types").IndexUiState)) => string;
    } & {
    ...
    dispose({ recommendState }: import("instantsearch.js/es/types").DisposeOptions): import("algoliasearch-helper").RecommendParameters;
