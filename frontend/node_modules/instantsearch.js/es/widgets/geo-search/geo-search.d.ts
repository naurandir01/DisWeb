import type { GeoSearchConnectorParams, GeoSearchWidgetDescription, GeoHit } from 'instantsearch.js/es/connectors/geo-search/connectGeoSearch';
import type { GeoLoc, Template, WidgetFactory } from 'instantsearch.js/es/types';
import type { HTMLMarkerArguments } from 'instantsearch.js/es/widgets/geo-search/createHTMLMarker';
...
declare const _default: <THit extends GeoHit = GeoHit>(widgetParams: GeoSearchWidgetParams<THit> & GeoSearchConnectorParams<THit>) => {
    $$widgetType: "ais.geoSearch";
    $$type: "ais.geoSearch";
    init(initArgs: import("instantsearch.js/es/types").InitOptions): void;
    render(renderArgs: import("instantsearch.js/es/types").RenderOptions): void;
    getWidgetRenderState(renderOptions: import("instantsearch.js/es/types").InitOptions | import("instantsearch.js/es/types").RenderOptions): {
        ...
        widgetParams: {
            renderState: {
                templateProps?: import("instantsearch.js/es/lib/templating").PreparedTemplateProps<GeoSearchTemplates>;
            ...
            cssClasses: import("instantsearch.js/es/types").ComponentCSSClasses<Partial<{
                /** The root div of the widget. */
                root: string | string[];
                /** The map container of the widget. */
                map: string | string[];
    ...
    getRenderState(renderState: {
        ...
        geoSearch?: import("instantsearch.js/es/types").WidgetRenderState<import("instantsearch.js/es/connectors/geo-search/connectGeoSearch").GeoSearchRenderState<GeoHit>, GeoSearchConnectorParams<GeoHit>> | undefined;
        hierarchicalMenu?: {
    ...
    }, renderOptions: import("instantsearch.js/es/types").InitOptions | import("instantsearch.js/es/types").RenderOptions): import("instantsearch.js/es/types").IndexRenderState & GeoSearchWidgetDescription["indexRenderState"];
    dispose({ state }: import("instantsearch.js/es/types").DisposeOptions): import("algoliasearch-helper").SearchParameters;
