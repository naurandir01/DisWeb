...
import type { RefinementListConnectorParams, RefinementListWidgetDescription } from 'instantsearch.js/es/connectors/refinement-list/connectRefinementList';
import type { Template, WidgetFactory } from 'instantsearch.js/es/types';
import type { SearchBoxTemplates } from 'instantsearch.js/es/widgets/search-box/search-box';
