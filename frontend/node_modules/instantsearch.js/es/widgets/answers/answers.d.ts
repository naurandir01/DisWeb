...
import type { AnswersConnectorParams, AnswersWidgetDescription } from 'instantsearch.js/es/connectors/answers/connectAnswers';
import type { WidgetFactory, Template, Hit } from 'instantsearch.js/es/types';
