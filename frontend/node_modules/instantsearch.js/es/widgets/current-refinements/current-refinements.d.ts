...
import type { CurrentRefinementsConnectorParams, CurrentRefinementsWidgetDescription } from 'instantsearch.js/es/connectors/current-refinements/connectCurrentRefinements';
import type { WidgetFactory } from 'instantsearch.js/es/types';
