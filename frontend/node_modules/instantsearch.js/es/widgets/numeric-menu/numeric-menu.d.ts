...
import type { NumericMenuConnectorParams, NumericMenuWidgetDescription } from 'instantsearch.js/es/connectors/numeric-menu/connectNumericMenu';
import type { ComponentCSSClasses, Template, WidgetFactory } from 'instantsearch.js/es/types';
