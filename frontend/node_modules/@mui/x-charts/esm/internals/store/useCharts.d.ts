...
import { ChartAnyPluginSignature, ChartInstance, ChartPublicAPI, ConvertSignaturesIntoPlugins } from "@mui/x-charts/internals/plugins/models";
...
import { ChartSeriesConfig } from "@mui/x-charts/internals/plugins/models/seriesConfig";
/**
...
export declare function useCharts<TSeriesType extends ChartSeriesType, TSignatures extends readonly ChartAnyPluginSignature[]>(inPlugins: ConvertSignaturesIntoPlugins<TSignatures>, props: Partial<UseChartBaseProps<TSignatures>>, seriesConfig: ChartSeriesConfig<TSeriesType>): {
  contextValue: {
    store: ChartStore<readonly [import("@mui/x-charts/internals").UseChartIdSignature, import("@mui/x-charts/internals").UseChartDimensionsSignature, import("@mui/x-charts/internals").UseChartSeriesSignature, import("@mui/x-charts/internals/plugins/corePlugins/useChartAnimation").UseChartAnimationSignature, ...TSignatures]> & UseChartInteractionState;
