...
export declare function createAllSeriesSelectorOfType<T extends keyof ChartsSeriesConfig>(seriesType: T): () => import("@mui/x-charts/internals").ProcessedSeries<keyof ChartsSeriesConfig>[T];