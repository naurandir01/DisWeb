...
import { ChartPluginSignature, ChartSeriesConfig } from "@mui/x-charts/internals/plugins/models";
...
export type UseChartSeriesDefaultizedParameters<T extends ChartSeriesType = ChartSeriesType> = UseChartSeriesParameters<T> & {
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
