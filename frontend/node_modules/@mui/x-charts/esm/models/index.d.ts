export * from "@mui/x-charts/models/seriesType";
...
export type { ChartBaseCommonProps, ChartBaseIconProps, ChartsIconSlots, ChartsBaseSlots } from "@mui/x-charts/models/slots";