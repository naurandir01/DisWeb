...
export declare function useXAxes(): {
  xAxis: import("@mui/x-charts/internals").ComputedAxisConfig<import("@mui/x-charts").ChartsXAxisProps>;
  xAxisIds: string[];
};
/**
 * Get all the y-axes.
...
export declare function useYAxes(): {
  yAxis: import("@mui/x-charts/internals").ComputedAxisConfig<import("@mui/x-charts").ChartsYAxisProps>;
  yAxisIds: string[];
};
/**
 * Get the X axis.
 ...
 * @returns The X axis.
 */
export declare function useXAxis(axisId?: AxisId): import("@mui/x-charts/internals").ComputedAxis<keyof import("@mui/x-charts/internals").AxisScaleConfig, any, import("@mui/x-charts").ChartsXAxisProps>;
/**
 * Get the Y axis.
 * @param {AxisId | undefined} axisId - If provided returns the y axis with axisId, else returns the values for the default y axis.
 * @returns The Y axis.
 */
export declare function useYAxis(axisId?: AxisId): import("@mui/x-charts/internals").ComputedAxis<keyof import("@mui/x-charts/internals").AxisScaleConfig, any, import("@mui/x-charts").ChartsYAxisProps>;
