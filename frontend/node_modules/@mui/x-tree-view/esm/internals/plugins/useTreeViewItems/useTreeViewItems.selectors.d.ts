import { TreeViewItemMeta } from "@mui/x-tree-view/internals/models";
 ...
 */
export declare const selectorIsTreeViewLoading: ((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewItems.types.js").UseTreeViewItemsState<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties> & Partial<{}> & {
 ...
 */
export declare const selectorGetTreeViewError: ((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewItems.types.js").UseTreeViewItemsState<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties> & Partial<{}> & {
  cacheKey: import("@mui/x-tree-view/internals/models").TreeViewStateCacheKey;
}) => Error | null) & {
  clearCache: () => void;
  resultsCount: () => number;
 ...
 */
export declare const selectorItemMetaLookup: ((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewItems.types.js").UseTreeViewItemsState<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties> & Partial<{}> & {
  cacheKey: import("@mui/x-tree-view/internals/models").TreeViewStateCacheKey;
}) => {
  [itemId: string]: TreeViewItemMeta;
}) & {
 ...
 */
export declare const selectorItemModel: ((state: any, itemId: string) => import("@mui/x-tree-view").TreeViewBaseItem<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties>) & {
  clearCache: () => void;
  resultsCount: () => number;
  resetResultsCount: () => void;
} & {
  resultFunc: (resultFuncArgs_0: {
    ...
    loading: boolean;
    error: Error | null;
  }, resultFuncArgs_1: string) => import("@mui/x-tree-view").TreeViewBaseItem<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties>;
  memoizedResultFunc: ((resultFuncArgs_0: {
    disabledItemsFocusable: boolean;
    itemModelLookup: {
      [itemId: string]: import("@mui/x-tree-view").TreeViewBaseItem<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties>;
  ...
  lastResult: () => import("@mui/x-tree-view").TreeViewBaseItem<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties>;
...
export declare const selectorItemMeta: ((state: any, itemId: string | null) => TreeViewItemMeta | null) & {
  ...
  dependencies: [((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewItems.types.js").UseTreeViewItemsState<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties> & Partial<{}> & {
    cacheKey: import("@mui/x-tree-view/internals/models").TreeViewStateCacheKey;
  }) => {
    [itemId: string]: TreeViewItemMeta;
  }) & {
 ...
 */
export declare const selectorDisabledItemFocusable: ((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewItems.types.js").UseTreeViewItemsState<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties> & Partial<{}> & {
  cacheKey: import("@mui/x-tree-view/internals/models").TreeViewStateCacheKey;
}) => boolean) & {
  clearCache: () => void;
  resultsCount: () => number;
