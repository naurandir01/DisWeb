...
export declare const selectorSelectionModel: ((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewSelection.types.js").UseTreeViewSelectionState & Partial<{}> & {
  ...
  resultFunc: (resultFuncArgs_0: {
    ...
    selectionPropagation: import("@mui/x-tree-view").TreeViewSelectionPropagation;
  }) => string | string[] | null;
...
export declare const selectorIsItemSelectionEnabled: ((state: any, itemId: string) => boolean) & {
  ...
  dependencies: [((state: any, itemId: string) => boolean) & {
    ...
    lastResult: () => boolean;
    dependencies: [((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("@mui/x-tree-view/internals/plugins/useTreeViewItems").UseTreeViewItemsState<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties> & Partial<{}> & {
      cacheKey: import("@mui/x-tree-view/internals/models").TreeViewStateCacheKey;
    }) => {
      [itemId: string]: import("@mui/x-tree-view/internals").TreeViewItemMeta;
    }) & {
      ...
      dependencies: [TreeViewRootSelector<import("@mui/x-tree-view/internals/plugins/useTreeViewItems").UseTreeViewItemsSignature>];
      recomputations: () => number;
      resetRecomputations: () => void;
      dependencyRecomputations: () => number;
      resetDependencyRecomputations: () => void;
...
export declare const selectorSelectionPropagationRules: ((state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState & import("./useTreeViewSelection.types.js").UseTreeViewSelectionState & Partial<{}> & {
  cacheKey: import("@mui/x-tree-view/internals/models").TreeViewStateCacheKey;
}) => import("@mui/x-tree-view").TreeViewSelectionPropagation) & {
  clearCache: () => void;
  resultsCount: () => number;
  resetResultsCount: () => void;
} & {
  ...
  lastResult: () => import("@mui/x-tree-view").TreeViewSelectionPropagation;
  dependencies: [TreeViewRootSelector<UseTreeViewSelectionSignature>];
  recomputations: () => number;
  resetRecomputations: () => void;
  dependencyRecomputations: () => number;
