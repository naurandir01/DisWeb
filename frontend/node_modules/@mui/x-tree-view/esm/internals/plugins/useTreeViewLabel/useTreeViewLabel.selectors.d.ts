...
export declare const selectorIsItemEditable: ((state: any, itemId: string) => boolean) & {
  ...
  } | undefined, resultFuncArgs_1: import("@mui/x-tree-view").TreeViewBaseItem<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties>) => boolean;
  ...
  lastResult: () => boolean;
  dependencies: [TreeViewRootSelector<UseTreeViewLabelSignature, true>, (state: any, itemId: string) => import("@mui/x-tree-view").TreeViewBaseItem<import("@mui/x-tree-view").TreeViewDefaultItemModelProperties>];
